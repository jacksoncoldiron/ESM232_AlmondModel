...
yearly_anomalies <- suppressWarnings(as.numeric(yearly_anomalies))
yearly_anomalies <- yearly_anomalies[!is.na(yearly_anomalies)]
...
Our almond yield model investigated how uncertainty in temperature and precipitation coefficients affects almond yield anomaly for all years together.
